...
class CJsonRpc {
	...
	public function execute() {
		...
		if (is_array($this->_jsonDecoded)
			...
			return $this->json->encode(array_values(array_filter($this->_response)), [], false, false);
		}

		return ($this->_response[0] !== null) ? $this->json->encode($this->_response[0], [], false, false) : '';
	}
