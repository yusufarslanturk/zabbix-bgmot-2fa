...
class testFormItemPrototypePreprocessing extends testFormPreprocessing {
	...
	public $selector = 'Create item prototype';
	...
	public function testFormItemPrototypePreprocessing_CreateAllSteps($data) {
		$this->executeCreate($data, $this->link, $this->selector, 'Item prototype added', $this->ready_link, $this->fail_message);
	}
	 ...
	 */
	public function testFormItemPrototypePreprocessing_PreprocessingInheritanceFromTemplate($preprocessing) {
		$fields = [
