...
<<<<<<< HEAD
	static final String REVISION_DATE = "7 June 2021";
	static final String REVISION = "{ZABBIX_REVISION}";
	static final String VERSION = "5.4.1";
=======
	static final String REVISION_DATE = "29 March 2021";
	static final String REVISION = "{ZABBIX_REVISION}";
	static final String VERSION = "5.2.6";
>>>>>>> 5.2.6-bg
