...
if [ -z "$(grep ZBX_AUTH_2FA_NONE include/defines.inc.php)" ]; then echo "define('ZBX_AUTH_2FA_NONE', 0);" >> include/defines.inc.php; fi
if [ -z "$(grep ZBX_AUTH_2FA_DUO include/defines.inc.php)" ]; then echo "define('ZBX_AUTH_2FA_DUO',    1);" >> include/defines.inc.php; fi
if [ -z "$(grep ZBX_AUTH_2FA_GGL include/defines.inc.php)" ]; then echo "define('ZBX_AUTH_2FA_GGL',    2);" >> include/defines.inc.php; fi
if [ -z "$(grep AUDIT_RESOURCE_AD_GROUP include/defines.inc.php)" ]; then echo "define('AUDIT_RESOURCE_AD_GROUP',    100);" >> include/defines.inc.php; fi
