...
curl -L -o bg-patch-${VERSION}.zip https://github.com/BGmot/zabbix/raw/release/6.2-bg/bg-patch-${VERSION}.zip
...
cp ${ZABBIX_INSTALL_PATH}/include/classes/api/services/CUserDirectory.php ${ZABBIX_INSTALL_PATH}/include/classes/api/services/CUserDirectory.php-`date +%s`.bak
cp CUserDirectory.php ${ZABBIX_INSTALL_PATH}/include/classes/api/services/
cd ../../
