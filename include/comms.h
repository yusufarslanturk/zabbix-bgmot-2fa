...
#define zbx_tcp_send(s, d)				zbx_tcp_send_ext((s), (d), strlen(d), (ZBX_TCP_PROTOCOL|ZBX_TCP_COMPRESS), 0)
#define zbx_tcp_send_to(s, d, timeout)			zbx_tcp_send_ext((s), (d), strlen(d), (ZBX_TCP_PROTOCOL|ZBX_TCP_COMPRESS), timeout)
#define zbx_tcp_send_bytes_to(s, d, len, timeout)	zbx_tcp_send_ext((s), (d), len, (ZBX_TCP_PROTOCOL|ZBX_TCP_COMPRESS), timeout)
