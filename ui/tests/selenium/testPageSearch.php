...
class testPageSearch extends CWebTest {
	...
	public static function prepareData() {
		...
		$templateGroupId = CDataHelper::call('templategroup.create', [['name' => self::$search_string.' Templategroup']])['groupids'][0];
	...
	public function testPageSearch_Layout() {
		...
		foreach (self::$widget_params as $wp) {
			$widget_selector = 'xpath://section[@id='.CXPathHelper::escapeQuotes($wp['selector_id']).']';
