...
class testPageSearch extends CWebTest {
	...
	public function prepareData() {
		...
		$entity_templategroup_id = $response['groupids'][0];
		...
		$response = CDataHelper::createTemplates([
			...
			[
				...
				'groups' => ['groupid' => $entity_templategroup_id],
				'items' => [
					[
						'name' => 'Item 1',
						'key_' => 'key[1]',
		...
		CDataHelper::call('template.create', ['host' => 'Empty Template B', 'groups' => ['groupid' => $entity_templategroup_id]]);
